...
export default function ProductForm({product,columns,onClose}){
  ...
  const submit=event=>{
    ...
    const data={...f,barcode:f.barcode||f.productCode,openingBalance:Number(f.openingBalance===''?f.currentStock:f.openingBalance),currentStock:+f.currentStock,minStock:+f.minStock,maxStock:+f.maxStock};
